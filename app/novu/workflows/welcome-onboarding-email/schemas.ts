...
export const payloadSchema = z.object({
  ...
  inAppBody: z.string().describe('The body of the notification').default('This is an in-app notification powered by Novu.'),
  inAppAvatar: z.string().describe('The avatar of the notification').default('https://avatars.githubusercontent.com/u/77433905?s=200&v=4'),
  teamImage: z
    .string()
    .url()
    .default(
